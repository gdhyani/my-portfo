...
export default function Footer() {
    return (
        <div className="m-auto max-w-7xl my-5 shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] bg-white border-slate-200 rounded-2xl gap-2 sm:pt-10 pt-4  flex flex-col justify-between   text-center">
