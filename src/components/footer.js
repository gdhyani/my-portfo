...
export default function Footer() {
    return (
        <div className="m-auto max-w-7xl my-10 bg-white border-slate-200 rounded-2xl gap-2 sm:pt-10 pt-4  flex flex-col justify-between   text-center">
            ...
            <h1 className="text-center bg-slate-100 opacity-50">
