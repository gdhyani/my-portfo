...
export default function Navbar() {
    return (
        <div className=" sticky top-0 z-50 -mb-12 sm:-mb-14">
            <div className="h-20 bg-[#eceff3]"></div>
            <div className="mx-4 md:mx-auto relative -top-16  rounded-2xl bg-white shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] items-center flex justify-between flex-row max-w-7xl py-4 pr-3 sm:p-3">
